    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/services') || request()->is('admin/services*') || request()->is('admin/service-types') || request()->is('admin/service-types*') ? 'menu-open' : '' }} ">
                <a href="#" class="nav-link {{ Request::routeIs('service_types.index') || Request::routeIs('services.index') ? 'active' : '' }}">
            ...
            <li class="nav-item has-treeview  {{ request()->is('admin/projects') || request()->is('admin/projects/*') || request()->is('admin/project-categories') || request()->is('admin/project-categories/*') ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('ProjectCategory.index') }}" class="nav-link {{ Request::routeIs('ProjectCategory.create') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh mục dự án</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('ProjectCategory.create') }}" class="nav-link {{ Request::routeIs('ProjectCategory.create') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Thêm mới danh mục</p>
                        </a>
                    </li>
...
{{--                    </li>--}}
                    ...
                    <li class="nav-item">
                        <a href="{{ route('Founder.index') }}" class="nav-link {{ Request::routeIs('Founder.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh mục người sáng lập</p>
                        </a>
                    </li>
