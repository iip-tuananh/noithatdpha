            ...
            columns: [
                {data: 'DT_RowIndex', orderable: false, title: "STT"},
                {
                    ...
                    render: function (data) {
                        return `<img src="${data ? data.path : 'https://placehold.co/55x55'}" style="max-width: 55px !important">`;
                    }
                },
                {data: 'title',title: 'Tên dự án'},
                {data: 'address', title: 'Địa điểm'},
                {data: 'category_id', title: 'Danh mục dự án'},
                {data: 'show_home_page', title: 'Hiển thị ngoài trang chủ'},
