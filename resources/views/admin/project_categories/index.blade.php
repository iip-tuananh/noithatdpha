...
@endsection
@section('buttons')
    <a href="{{ route('ProjectCategory.create') }}" class="btn btn-outline-success btn-sm" class="btn btn-info"><i
            class="fa fa-plus"></i> Thêm mới</a>
@endsection
@section('content')
    <div ng-cloak>
        <div class="row" ng-controller="ProjectCategory">
            <div class="col-12">
                <div class="card">
                    <div class="nested-box">
                        <div class="col-lg-12 row-button">
                            <menu id="nestable-menu">
                                <button type="button" class="btn-outline-primary btn-sm" data-action="expand-all">Mở rộng
                                    <i class="fa fa-plus"></i></button>
                                <button type="button" class="btn-outline-danger btn-sm" data-action="collapse-all">Thu gọn
                      ...
                      <div class="dd3-content"> <span id="label_show' .
                                                        $value['id'] .
                                                        '">' .
                                                        $value['name'] .
                                                        '</span>
                        <span class="span-right">
                            ' .
                                                        ($value['parent_id'] == 0
                                                            ? '<a class="link-button" href="' .
                                                                route('ProjectCategory.edit', $value['id']) .
                                                                '" id="' .
                                                                $value['id'] .
                                                                '" label="' .
                                                                $value['name'] .
                          ...
                          <a class="del-button confirm" href="' .
                                                        route('ProjectCategory.delete', $value['id']) .
                                                        '" id="' .
                                                        $value['id'] .
                                            ...
                                            <div class="form-group custom-group ">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="form-control" ng-model="form.show_home_page">
                                                        ...
                                                        <option ng-repeat="s in show_home_page" ng-value="s.value"
                                                            ng-selected="s.value == form.show_home_page">
                                                            <% s.name %>
                                                        </option>
                                                    </select>
                                                </div>
...
@section('script')
    ...
    <script>
        ...
        app.controller('ProjectCategory', function($rootScope, $scope, $http) {
            $scope.loading = {};
            $scope.form = {}
            ...
            $('.link-button').on('click', function(e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "/admin/project-categories/" + cate_id + "/getDataForEdit",
                    headers: {
                        'X-CSRF-TOKEN': CSRF_TOKEN
                    },
                    success: function(response) {
            ...
            $scope.submit = function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{!! route('ProjectCategory.add.home.page') !!}",
                    headers: {
                        'X-CSRF-TOKEN': CSRF_TOKEN
                    },
                    data: {
