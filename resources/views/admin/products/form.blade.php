...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <div class="form-group custom-group mb-4">
            ...
            <input class="form-control " type="text" ng-model="form.brand_name">
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.brand_name[0] %>
                </strong>
        ...
        <div class="form-group custom-group mb-4">
            ...
            <input class="form-control " type="text" ng-model="form.weight">
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.weight[0] %>
                </strong>
        ...
        <div class="form-group custom-group mb-4">
            ...
            <input class="form-control " type="text" ng-model="form.stock_qty">
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.stock_qty[0] %>
                </strong>
