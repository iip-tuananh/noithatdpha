...
Route::group(['namespace' => 'Front'], function () {
    ...
    // projects
    Route::get('/du-an/{slug}.html','FrontController@showCategoryProject')->name('front.show-project-category');
    Route::get('/chi-tiet-du-an/{slug}.html','FrontController@showProjectDetail')->name('front.show-project-detail');
